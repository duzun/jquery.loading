 ...
 * @version 1.4.0
 */
export default function initLoading($: JQueryStatic): ClassLoadingPlugin {
     ...
     */
    const loading: ClassLoadingPlugin = function loading(
            classes,
            retCb = undefined
        )
    {
    ...
    function isOnViewport(elem): boolean {
